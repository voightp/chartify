...
def test_filled_circle_pixmap(qtbot):
    p = filled_circle_pixmap(QSize(100, 100), QColor(100, 100, 100))
    img = p.toImage()
...
def test_filled_circle_pixmap_fraction(qtbot):
    p = filled_circle_pixmap(QSize(100, 100), QColor(100, 100, 100), fraction=0.1)
    img = p.toImage()
    assert p.size() == QSize(100, 100)
...
def test_filled_circle_pixmap_two_colors(qtbot):
    p = filled_circle_pixmap(QSize(100, 100), QColor(100, 100, 100), QColor(0, 0, 0))
    img = p.toImage()
    assert p.size() == QSize(100, 100)
